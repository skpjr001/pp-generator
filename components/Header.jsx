...
function Header() {
  return (
    ...
    <Box width={"full"} position={"fixed"}>
      <Divider h={"2"}  bg={"messenger.600"} orientation={"horizontal"}/>
      <Flex px={{base:"5",md:"10", xl:"20"}} py={"2"} bg={"white"} direction={{base:"column",md:"row"}} height={"fit-content"} alignItems={"center"} justifyContent={"space-between"} boxShadow={"2xl"}>
        <Heading  size={"lg"} textAlign={"left"} textColor={"blackAlpha.700"}><Link href={`/`}><a>Privacy Policy Generator</a></Link></Heading>
        <Flex>
